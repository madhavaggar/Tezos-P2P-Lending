(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taquito/rpc'), require('@taquito/signer'), require('rxjs'), require('rxjs/operators'), require('bignumber.js'), require('@taquito/michelson-encoder'), require('@taquito/michel-codec'), require('@taquito/utils'), require('@taquito/http-utils')) :
    typeof define === 'function' && define.amd ? define(['exports', '@taquito/rpc', '@taquito/signer', 'rxjs', 'rxjs/operators', 'bignumber.js', '@taquito/michelson-encoder', '@taquito/michel-codec', '@taquito/utils', '@taquito/http-utils'], factory) :
    (global = global || self, factory(global.taquito = {}, global.rpc, global.signer, global.rxjs, global.operators, global.BigNumber, global.michelsonEncoder, global.michelCodec, global.utils, global.httpUtils));
}(this, (function (exports, rpc, signer, rxjs, operators, BigNumber, michelsonEncoder, michelCodec, utils, httpUtils) { 'use strict';
